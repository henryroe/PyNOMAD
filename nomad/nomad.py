...
"""
    ...
    TODO: document code to generate the usnob1_stars_per_file
    Here's a quick first version....needs work:
        def play_with_USNOB_numbers():
            ...
            f.close()
"""
usnob1_stars_per_file = np.array([322, 1169, 1823, 2612, 3371, 4139, 4808, 5765, 6444, 7322, 8016, 8909, 9670, 10314,
...
usnob1_stars_per_file_cumsum = usnob1_stars_per_file.cumsum()
...
def _determine_usnob1_id_from_usnob1_integer(usnob1_integer):
    if usnob1_integer == 0:
        ...
        file_number = (usnob1_stars_per_file_cumsum > usnob1_integer).argmax()
        star_number = usnob1_integer - usnob1_stars_per_file_cumsum[file_number - 1]
